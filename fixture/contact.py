...
class ContactHelper:
    ...
    def get_contact_list(self):
        if self.contact_cache is None:
            ...
            for element in wd.find_elements_by_name("entry"):
                ...
                self.contact_cache.append(Contact(lastname=text, id=id, firstname=text2, address=address,
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, id=id, address=address, email=email, email2=email2,
                       email3=email3, homephone=homephone, mobilephone=mobilephone, workphone=workphone,
